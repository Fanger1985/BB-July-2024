...
#define TRIG_PIN_REAR 16//changed from 4
...
let joystickCenter = document.getElementById("joystickCenter");
let active = false;
...
joystick.addEventListener("touchend", function() {
    active = false;
    sendCommand("/stop");
    joystickCenter.style.top = "50%";
    joystickCenter.style.left = "50%";
}, false);
...
function moveJoystick(e) {
    ...
    joystickCenter.style.top = y + "px";
    joystickCenter.style.left = x + "px";
