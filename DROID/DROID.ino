...
void performTaskA() {
    ...
    delay(200);
    stopMotors();
    Serial.println("Task A complete!");
}
...
void performTaskB() {
    ...
    delay(200);
    stopMotors();
    Serial.println("Task B complete!");
}
...
void performTaskC() {
    ...
    delay(200);
    stopMotors();
    Serial.println("Task C complete!");
}
...
<style>
  ...
  .joystick-handle {
    ...
    left: 35%;
    touch-action: none;
    box-shadow: inset 10px 10px 20px #0a0a0a, inset -10px -10px 20px #2a2a2a;
    -webkit-user-select: none; /* Safari */
    -ms-user-select: none; /* IE 10 and IE 11 */
    user-select: none; /* Standard syntax */
  }
...
<div class="container">
  ...
  <div class="right">
    <div class="buttons">
      ...
      <button class="stop" onclick='sendCommand("/stop")'><font color="red"><strong>STOP</strong></font></button>
    </div>
  </div>
</div>
<script>
let joystick = document.getElementById("joystick");
let joystickCenter = document.getElementById("joystick-handle");
let active = false;
...
joystick.addEventListener("mouseup", function() {
    active = false;
    sendCommand("/stop");
    joystickCenter.style.top = "35%";
    joystickCenter.style.left = "35%";
}, false);
...
function moveJoystick(e) {
    ...
    joystickCenter.style.top = (y / rect.height * 100 - 15) + "%";
    joystickCenter.style.left = (x / rect.width * 100 - 15) + "%";
